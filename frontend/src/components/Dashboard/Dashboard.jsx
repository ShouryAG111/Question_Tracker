...
const Dashboard = () => {
  ...
  const handleDifficultyFilter = async () => {
    ...
    try {
      const response = await axios.get('https://question-csgs.onrender.com/api/questions/byDifficulty', {
        headers: { Authorization: `Bearer ${token}` },
  ...
  const handleRatingFilter = async () => {
    ...
    try {
      const response = await axios.get('https://question-csgs.onrender.com/api/questions/byRating', {
        headers: { Authorization: `Bearer ${token}` },
  ...
  const handleTopicFilter = async () => {
    ...
    try {
      const response = await axios.get('https://question-csgs.onrender.com/api/questions/byTopic', {
        headers: { Authorization: `Bearer ${token}` },
  ...
  const handleTimeFilter = async () => {
    ...
    try {
      const response = await axios.get('https://question-csgs.onrender.com/api/questions/byTimeSpent', {
        headers: { Authorization: `Bearer ${token}` },
